...
Version: 1.0.0
Author: Financial Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Financial Calculator by www.calculator.io";

function display_calcio_ci_financial_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_financial_calculator', 'display_calcio_ci_financial_calculator' );